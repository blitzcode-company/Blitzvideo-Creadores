...
export class ReproductorStreamComponent implements OnInit, OnDestroy, AfterViewInit, OnChanges {
  ...
  @Input() estadoStream: string | undefined;
  @Output() streamIniciado = new EventEmitter<void>();
  @Output() streamFinalizado = new EventEmitter<void>();
...
private inicializarVideoJS(video: HTMLVideoElement): void {
  ...
  this.player.on('playing', () => {
    this.isPlaying = true;
    this.streamIniciado.emit(); 
    this.cdr.markForCheck();
  });

  this.player.on('ended', () => {
    this.isPlaying = false;
    this.streamFinalizado.emit(); 
    this.cdr.markForCheck();
  });
